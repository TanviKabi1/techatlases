                      ...
                      <div key={priority}>
                        ...
                        <div className="space-y-3">
                          {items.map((rec, i) => {
                            ...
                            const diffConfig = DIFFICULTY_CONFIG[rec.difficulty];
                                      ...
                                      {isExpanded && (
                                        ...
                                        >
                                          <div className="mt-4 pt-4 border-t border-border/50 space-y-4">
                                            <div>
                                              <p className="text-xs text-muted-foreground mb-1">Why Learn This</p>
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                              ...
                                              <div>
                                                <p className="text-xs text-muted-foreground mb-1">Time to Productive</p>
                                                <p className="text-sm font-semibold text-foreground">{rec.timeToLearn} weeks</p>
                                              </div>
                                            </div>
                                            <div>
                                              <p className="text-xs text-muted-foreground mb-1 flex items-center gap-1">
                                                <Zap className="w-3 h-3" /> Synergy with Your Stack
                                              </p>
